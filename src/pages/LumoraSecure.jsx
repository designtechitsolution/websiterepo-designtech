...
const LumoraSecure = () => {
  ...
  const features = [
    {
      ...
      description: "Continuous monitoring to detect and block intrusions in real-time",
      icon: <Eye className="w-5 h-5 sm:w-6 sm:h-6" />,
      color: "from-blue-600 to-cyan-500"
    },
    {
      title: "Penetration Testing",
      description: "Proactive identification of security vulnerabilities",
      icon: <ShieldCheck className="w-5 h-5 sm:w-6 sm:h-6" />,
      color: "from-cyan-500 to-teal-500"
    },
    {
      title: "Data Protection",
      description: "GDPR, HIPAA, and ISO 27001 compliance solutions",
      icon: <Lock className="w-5 h-5 sm:w-6 sm:h-6" />,
      color: "from-teal-500 to-emerald-500"
    },
    {
      title: "Cloud Security",
      description: "End-to-end protection for hybrid and multi-cloud environments",
      icon: <Cloud className="w-5 h-5 sm:w-6 sm:h-6" />,
      color: "from-emerald-500 to-green-500"
    },
    {
      title: "IAM Solutions",
      description: "Secure identity and access management for your organization",
      icon: <Key className="w-5 h-5 sm:w-6 sm:h-6" />,
      color: "from-green-500 to-yellow-500"
    },
    {
      title: "Incident Response",
      description: "24/7 security operations center and rapid response team",
  ...
  const securityStats = [
    { value: "99.99%", label: "Threat Detection Rate" },
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-start bg-gradient-to-br from-gray-50 via-white to-gray-100 px-4 sm:px-6 py-12 sm:py-16 md:py-20 overflow-hidden">
      ...
      <div className="absolute bottom-4 sm:bottom-10 left-4 sm:left-10 w-40 h-40 sm:w-60 sm:h-60 md:w-72 md:h-72 lg:w-80 lg:h-80 bg-teal-400/10 sm:bg-teal-400/15 rounded-full blur-xl sm:blur-2xl md:blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute top-1/3 left-1/4 w-36 h-36 sm:w-48 sm:h-48 md:w-60 md:h-60 lg:w-72 lg:h-72 bg-cyan-300/5 sm:bg-cyan-300/10 rounded-full blur-xl sm:blur-2xl md:blur-3xl animate-pulse"></div>
      
      {/* Header - Responsive */}
      <div className="relative w-full max-w-6xl text-center mb-12 sm:mb-16 md:mb-20 z-10 animate-fadeInUp px-2 sm:px-4">
        <div className="bg-gradient-to-r from-blue-700 via-cyan-600 to-teal-500 text-white py-10 sm:py-12 md:py-16 px-4 sm:px-6 rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl md:shadow-2xl transform transition-all duration-500 group relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/20 shadow-lg">
              <Shield className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-yellow-400 animate-float" />
            </div>
            ...
            <p className="mt-2 sm:mt-3 text-sm sm:text-base md:text-lg text-gray-100 max-w-3xl mx-auto leading-relaxed">
              Your Digital Shield Against Modern Cyber Threats
            </p>
          </div>
        </div>
        ...
        {!isMobile && (
          <div className="absolute -bottom-8 sm:-bottom-10 left-1/2 transform -translate-x-1/2 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-yellow-400 to-amber-500 shadow-lg flex items-center justify-center animate-pulse-glow">
            <Shield className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-white animate-bounce-slow" />
          </div>
        )}
      </div>
        ...
        <div className="mt-12 sm:mt-16 md:mt-20 w-full max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-6 sm:p-8 md:p-10 shadow-lg border border-blue-100">
            <div className="text-center">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-3">Ready to Secure Your Digital Assets?</h3>
      ...
      {isMobile && (
        <div className="fixed bottom-6 right-6 z-20">
          <a
            ...
            aria-label="Contact us about security solutions"
          >
